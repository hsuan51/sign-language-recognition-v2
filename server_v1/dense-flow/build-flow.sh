...
do
  ...
  #LD_LIBRARY_PATH=/usr/local/opencv/lib build/denseFlow_gpu --vidFile=$line --xFlowFile="$dir/x/flow_x" --yFlowFile="$dir/y/flow_y" --device_id=$did --type=$type --bound=$bound --clip=20000 --step=3
  LD_LIBRARY_PATH=/usr/local/opencv/lib build/denseFlow_gpu --vidFile=$line --xFlowFile="$dir/x/flow_x" --yFlowFile="$dir/y/flow_y" --imgFile="$dir/i/im" --device_id=$did --type=$type --bound=$bound --clip=20000 --step=3
