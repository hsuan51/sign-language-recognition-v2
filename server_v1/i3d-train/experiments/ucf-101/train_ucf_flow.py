...
flags.DEFINE_integer('classics', 5, 'The num of class')
FLAGS = flags.FLAGS

#model_save_dir = './models/flow_scratch_0626'
model_save_dir = './models/flow_imagenet_0626'
        
#flow_pre_model_save_dir = "/home/g1105137135/i3d-train/checkpoints/flow_scratch"
flow_pre_model_save_dir = "/home/g1105137135/i3d-train/checkpoints/flow_imagenet"
...
def run_training():
    ...
    with tf.Graph().as_default():
        ...
        learning_rate = tf.compat.v1.train.exponential_decay(FLAGS.learning_rate, global_step, decay_steps=5000, decay_rate=0.1, staircase=True)
        opt_flow = tf.compat.v1.train.AdamOptimizer(learning_rate)
        ...
        tf.compat.v1.summary.scalar('flow_loss', flow_loss)
    ...
    train_writer = tf.compat.v1.summary.FileWriter('./visual_logs/train_flow_0626', sess.graph)
    test_writer = tf.compat.v1.summary.FileWriter('./visual_logs/test_flow_0626', sess.graph)
    for step in xrange(FLAGS.max_steps):
        ...
        rgb_train_images, flow_train_images, train_labels, _, _, _ = input_data.read_clip_and_label(
                      ...
                      num_frames_per_clip=FLAGS.num_frame_per_clib * sample_rate,
